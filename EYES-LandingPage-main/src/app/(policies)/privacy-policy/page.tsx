    ...
    <div className="w-full flex flex-col h-auto lg:h-[calc(100vh-140px)] lg:min-h-0">
      ...
      <div className="mb-4 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 shrink-0">
        ...
        <div className="text-left md:text-right shrink-0">
          <p className="font-mono text-[10px] text-[var(--text-secondary)] uppercase tracking-[0.2em] opacity-80">
            Last Updated: June 4, 2026
          </p>
          <p className="text-xs text-emerald-400 font-medium flex items-center md:justify-end gap-1.5 mt-1">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
            Zero-Retention AI APIs Active
          </p>
        </div>
      </div>
