        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 w-full">
          ...
          <div className="flex items-center gap-4 md:w-auto -ml-4 md:-ml-26">
            <div className="flex items-center gap-1">
              <h1 className="font-serif text-5xl md:text-6xl leading-none">EYES</h1>
              <div className="flex flex-col text-[8px] md:text-[9px] font-semibold leading-[1.0] -ml-1.5 md:-ml-2 text-neutral-400">
          ...
          <div className="flex items-center justify-center md:justify-end gap-6 text-neutral-400 md:w-auto mt-4 md:mt-0">
            <a href="https://crescentmoon.ai/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors font-bold text-[15px] leading-none tracking-tight" aria-label="CM">
              CM
            </a>
            ...
            <a href="https://www.instagram.com/crescent_moon_consulting/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
