...
export function GoogleDocsIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#4285F4" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/>
      <path d="M14 2v6h6" fill="#1A73E8"/>
      <path fill="#fff" d="M8 13h8v2H8zm0 4h8v2H8zm0-8h8v2H8z"/>
    </svg>
  );
}

export function GoogleSheetsIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#0F9D58" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/>
      <path d="M14 2v6h6" fill="#188038"/>
      <path fill="#fff" d="M8 12h8v2H8zm0 4h8v2H8zM8 8h3v2H8zm5 0h3v2h-3z"/>
    </svg>
  );
}

export function GoogleSlidesIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#F4B400" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/>
      <path d="M14 2v6h6" fill="#E37400"/>
      <path fill="#fff" d="M7 10h10v6H7z"/>
    </svg>
  );
}

export function GoogleMeetIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path fill="#00832d" d="M22 6L16 11V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-5l6 5a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z"/>
    </svg>
  );
}

export function GoogleChatIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export function GoogleMapsIcon({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export function YouTubeIconOfficial({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path fill="#FF0000" d="M21.58 6.5A2.7 2.7 0 0 0 19.66 4.6c-1.7-.45-8.5-.45-8.5-.45s-6.8 0-8.5.45A2.7 2.7 0 0 0 .74 6.5a28.42 28.42 0 0 0 0 11.02 2.7 2.7 0 0 0 1.92 1.9c1.7.45 8.5.45 8.5.45s6.8 0 8.5-.45a2.7 2.7 0 0 0 1.92-1.9 28.42 28.42 0 0 0 0-11.02z"/>
      <path fill="#FFF" d="M9.5 15.5l6-3.5-6-3.5v7z"/>
    </svg>
  );
}
