...
export async function GET(request: Request) {
  ...
  if (!clientId) return NextResponse.redirect(new URL('/connect/fitbit?oauth=error&reason=missing_client_id', baseUrl));
  ...
  authUrl.searchParams.set('redirect_uri', new URL('/api/connect/fitbit/callback', baseUrl).toString());
