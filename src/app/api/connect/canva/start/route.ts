...
export async function GET() {
  ...
  if (!clientId) return NextResponse.redirect(new URL('/connect/canva?oauth=error&reason=missing_client_id', appBaseUrl()));
  ...
  authUrl.searchParams.set('redirect_uri', new URL('/api/connect/canva/callback', appBaseUrl()).toString());
